...
#     follower = models.ForeignKey(User, related_name='followingg', on_delete=models.CASCADE)
#     following = models.ForeignKey(User, related_name='followerss', on_delete=models.CASCADE)
...
class CommentReaction(models.Model):
    ...
    class Meta:
        ...
        # ----------------- Follow -----------------
class Follow(models.Model):
    follower = models.ForeignKey(User, related_name='following_interaction', on_delete=models.CASCADE)
    following = models.ForeignKey(User, related_name='followers_interaction', on_delete=models.CASCADE)
